...
\def\Keywords{%
{Taxi}, {Ruby on Rails}, {Web application}
}
...
In the attached ZIP file root  we can find the README.md file describing the whole application installation process. This file uses the standard markdown format.
